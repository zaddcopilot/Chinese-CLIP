...
# restore options
resume=${DATAPATH}/pretrained_weights/clip_cn_vit-l-14-336.pt # or specify your customed ckpt path to resume
...
name=muge_finetune_vit-l-14-336_roberta-base_bs128_1gpu
